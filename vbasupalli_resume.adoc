...
==== Skill Set
*	_Programming Languages_: Python, Java, Bash, C/C++, JavaScript
*	_Tools/Libraries/Frameworks_: : Docker, MongoDB, AWS (lightsail, KMS, Route-53, Lambda, SNS), Jenkins, Apache Maven, Apache Ant, Apache Gradle, Redis, Eclipse plugin development, JQuery, Bootstrap, Flask, Tornado, Web Sockets, SQLite, NGINX, dotnet core, RabbitMQ, Git, HTML, CSS, Message Passing Interface (MPI), OpenMP, Pthreads, Vectorization and Polyhedral Model Techniques
