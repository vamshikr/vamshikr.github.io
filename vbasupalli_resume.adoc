...
==== Summary & Highlights
*	12 years of programming experience in _Systems Programming, High Performance Computing (HPC), Embedded Systems_ and _Software Security_
...
*	Experience with _Jenkins_ plugin development
...
* Contributed to open source _static analysis security tools_ such as _bandit_ and _PMD_ with providing bug fixes
...
*	Experience with build systems _maven_, _gradle_, _ant_ and _make_
...
*	Have 4 publications including 1 first author publication
*	Master of Science (Major: Computer Science) with a thesis

==== Skill Set
*	_Programming Languages_: Python, Bash, Java, C/C++, JavaScript
*	_Tools/Libraries/Frameworks_: : Flask, Docker, MongoDB, AWS (lightsail, KMS, Route-53, Lambda, SNS), Jenkins, Message Passing Interface (MPI), OpenMP, Pthreads, Vectorization and Polyhedral Model Techniques, Apache Maven, Apache Ant, Apache Gradle, Eclipse plugin development, JQuery, dotnet core, Tornado, Web Sockets
...
-	Technical lead and one of the main back-end developers for SWAMP. Main responsibilities include automating the application of software assessments tools on software written in languages such as _Java, .NET, Python, Ruby, PHP_ and _JavaScript_
...
-	Added 26 different open source and commercial tools Static Analysis Tools covering various languages, frameworks and capabilities
-	Co-lead development of SWAMP CLI and plugins for Jenkins and Eclipse
...
The SWAMP Java CLI is a _Java library_ and a _command line interface_ that provides many common operations to a SWAMP instance such as get a list of projects, packages (versions), assessments, tools, & platforms. Users can also create/upload packages (versions), configure/start an assessment, check the status of an assessment, and download SCARF results +
...
.Jenkins plugins  (UW-Madison, Dec 2016 - Oct 2018)
Developed a  _Jenkins_ plug-in that allows Jenkins projects to use SWAMP to perform static code assessments on their code +
*Technologies/Environment:* Jenkins, Java

.blueJ plugin (UW-Madison, Mar 2014 - Apr 2014)
...
A set of programs to start a https://codedx.com/[CodeDx] viewer instance, upload SCARF results, download results from CodeDx +
...
Used advanced techniques like _Polyhedral Model_ and _Vectorization_ to optimize the performance of image processing algorithms for a client developing computer chip wafer inspection machines +
...
Worked on the development an in-vehicle network sniffer application +
...
.Palm OS based sales application (MindTree, July 2005 - Aug 2005)
...
* Machine Learning, by Andrew Ng. Aug 2017 - Sep 2017
